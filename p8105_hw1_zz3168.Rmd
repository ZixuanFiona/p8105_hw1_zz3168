...
```
In `early_january_weather` dataset contains information on weather conditions. It contain the origin, year, monrth, day, hour, temperature, dewp, humid, wind_speed, wind_gust, precip, pressure, visib and time_hour value. 
